...
if results != "":
    ...
    if snmpdetect == 1:
        ...
        SNMPWALK = "snmpwalk -c public -v1 %s 1 > /home/freemandyson/Projects/pentesting_tools/scans/%s_snmpwalk.txt" % (ip_address, ip_address)
...
resultsfile = "/home/freemandyson/Projects/pentesting_tools/scans/" + ip_address + "_snmprecon.txt"
